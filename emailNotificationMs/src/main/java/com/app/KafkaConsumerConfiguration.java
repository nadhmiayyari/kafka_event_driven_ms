...
public class KafkaConsumerConfiguration {
    ...
    ConcurrentKafkaListenerContainerFactory<String,Object> kafkaListenerContainerFactory(ConsumerFactory<String,Object> consumerFactory
        ...
        // used to handle exception that occur during message consumption by kafka listener
        // this class is used toi handle exceptions that occur during message consumption by kafka listener
        // when exceptions take places ,
        // the default error handler will rewind partitions after message failure.
        // so that it can be replayed to send message that could not be deserialized to a dead letter topic
